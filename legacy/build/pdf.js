...
var pdfjsVersion = '2.10.107';
var pdfjsBuild = 'c7c59feea';
{
  ...
  if (isNodeJS) {
    ...
    var PDFNetworkStream = __w_pdfjs_require__(134).PDFNetworkStream;

    var PDFFetchStream;

    if ((0, _display_utils.isFetchSupported)()) {
      PDFFetchStream = __w_pdfjs_require__(135).PDFFetchStream;
    }
